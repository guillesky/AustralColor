...
public class ImageProcessor
{
	...
	public static double[] getFilterMatrix(Mat inputRgb)
	{
		...
		/*
		 * debugMat("histR", histR); debugMat("histG", histG); debugMat("histB", histB);
		 */
		for (int x = 0; x < 256; x++)
		{
		...
		// 11) Resultado
		/*
		 * double[] result2=new double[] { adjustRed, adjustRedGreen, adjustRedBlue, 0,
		 * redOffset, 0, greenGain, 0, 0, greenOffset, 0, 0, blueGain, 0,blueOffset, 0,
		 * 0, 0, 1, 0 };
		 */
		double[] result = new double[]
		{ adjustRed, adjustRedGreen, adjustRedBlue, greenGain, blueGain, redOffset, greenOffset, blueOffset };
		return result;
	}
	...
	public static Mat applyFilter(Mat mat, double[] filt)
	{
	...
	private static Mat buildTransformMatrix(double[] f)
	{
		...
		/*
		 * m.put(0, 0, f[0], f[1], f[2], // R' 0, f[6], 0, // G' 0, 0, f[12] // B' );
		 */
	...
	{
		/*
		 * return new Scalar(f[4] * 255.0, // B f[9] * 255.0, // G f[14] * 255.0 // R
		 */
		return new Scalar(f[5] * 255.0, // B
				f[6] * 255.0, // G
				f[7] * 255.0 // R*
		);
	}
