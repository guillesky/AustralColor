...
public class Util
{
	...
	// ******************
	Language l = null;
	try (InputStream is = Util.class.getResourceAsStream(fileCode);
    ...
    {
	String[] languagesResources =
	{ "/i18n/de.json", "/i18n/en.json", "/i18n/es.json", "/i18n/fr.json", "/i18n/it.json", "/i18n/pt.json",
		"/i18n/ru.json" };
	AllLanguages result = null;

	result = new AllLanguages();
	for (String archivo : languagesResources)
	{
	    Language language = Util.readLanguage(archivo);
