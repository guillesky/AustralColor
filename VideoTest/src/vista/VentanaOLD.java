...
public class VentanaOLD extends JFrame implements IVista, ActionListener, TableModelListener, ChangeListener
{
		...
		public boolean importData(TransferSupport support)
		{
			...
			if (canImport(support))
			{
				...
				try
				{
					...
					VentanaOLD.this.controlador.addFiles(files);
			...
			if (result == JOptionPane.YES_OPTION)
			{
				...
				if (MediaTaskManager.getInstance().isWorking())
				{
					...
					t.addThreadWaiterListener(new ThreadWaiterListener()
					{
						...
						{
							VentanaOLD.this.controlador.shutdown();
